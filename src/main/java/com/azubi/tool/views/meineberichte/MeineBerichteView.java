package com.azubi.tool.views.meineberichte;
...
@PageTitle("Meine Berichte")
@Route(value = "meine-berichte", layout = MainLayout.class)
@PermitAll
public class MeineBerichteView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public MeineBerichteView() {
        addClassName("meine-berichte-view");
        setSizeFull();
        grid.setHeight("100%");
